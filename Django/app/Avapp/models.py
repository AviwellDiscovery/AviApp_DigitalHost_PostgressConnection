...
class Abundancefacttable(models.Model):
    sample_idsample = models.ForeignKey('Sample', models.DO_NOTHING,
                                        db_column='Sample_idSample')  # Field name made lowercase.
    item_iditem = models.ForeignKey('Item', models.DO_NOTHING, db_column='Item_idItem')  # Field name made lowercase.
    omics_idomics = models.ForeignKey('Omics', models.DO_NOTHING,
                                      db_column='Omics_idOMICS')  # Field name made lowercase.
    abundance = models.CharField(db_column='Abundance', max_length=45, blank=True,
...
class Analysis(models.Model):
    ...
    analysisname = models.CharField(db_column='AnalysisName', max_length=45, blank=True,
                                    null=True)  # Field name made lowercase.
    set_idset = models.ForeignKey('Set', models.DO_NOTHING, db_column='Set_IdSet', blank=True,
                                  null=True)  # Field name made lowercase.
    parameter = models.CharField(db_column='Parameter', max_length=2000, blank=True,
                                 null=True)  # Field name made lowercase.
...
class AppUser(models.Model):
    ...
    type_user = models.CharField(max_length=64)
...
class Feature(models.Model):
    ...
    featurename = models.CharField(db_column='FeatureName', max_length=45, blank=True,
                                   null=True)  # Field name made lowercase.
...
class Featurefacttable(models.Model):
    host_idhost = models.OneToOneField('Host', models.DO_NOTHING, db_column='Host_idHost',
                                       primary_key=True)  # Field name made lowercase.
    feature_idfeature = models.ForeignKey(Feature, models.DO_NOTHING,
                                          db_column='Feature_idFeature')  # Field name made lowercase.
...
class Gene(models.Model):
    ...
    genename = models.CharField(db_column='GeneName', max_length=45, blank=True,
                                null=True)  # Field name made lowercase.
    length = models.IntegerField(db_column='Length', blank=True, null=True)  # Field name made lowercase.
    genome_idgenome = models.ForeignKey('Genome', models.DO_NOTHING,
                                        db_column='Genome_idGenome')  # Field name made lowercase.
...
class Genome(models.Model):
    ...
    genomecategory = models.CharField(db_column='GenomeCategory', max_length=45, blank=True,
                                      null=True)  # Field name made lowercase.
...
class Host(models.Model):
    ...
    growthroom = models.CharField(db_column='GrowthRoom', max_length=45, blank=True,
                                  null=True)  # Field name made lowercase.
    study_idstudy = models.ForeignKey('Study', models.DO_NOTHING,
                                      db_column='Study_idStudy')  # Field name made lowercase.
...
class Item(models.Model):
    ...
    analysis_idanalysis = models.ForeignKey(Analysis, models.DO_NOTHING,
                                            db_column='Analysis_IdAnalysis')  # Field name made lowercase.
...
class Omics(models.Model):
    ...
    technology = models.CharField(db_column='Technology', max_length=45, blank=True,
                                  null=True)  # Field name made lowercase.
    platform = models.CharField(db_column='Platform', max_length=45, blank=True,
                                null=True)  # Field name made lowercase.
...
class OmicsHasQuality(models.Model):
    omics_idomics = models.OneToOneField(Omics, models.DO_NOTHING, db_column='Omics_idOmics',
                                         primary_key=True)  # Field name made lowercase.
    quality_idquality = models.ForeignKey('Quality', models.DO_NOTHING,
                                          db_column='Quality_idQuality')  # Field name made lowercase.
...
class Pen(models.Model):
    ...
    donorhen = models.CharField(db_column='DonorHen', max_length=45, blank=True,
                                null=True)  # Field name made lowercase.
    dietstarter = models.CharField(db_column='DietStarter', max_length=45, blank=True,
                                   null=True)  # Field name made lowercase.
...
class Quality(models.Model):
    ...
    qualityname = models.CharField(db_column='QualityName', max_length=45, blank=True,
                                   null=True)  # Field name made lowercase.
...
class Sample(models.Model):
    ...
    samplename = models.CharField(db_column='SampleName', max_length=45, blank=True,
                                  null=True)  # Field name made lowercase.
    host_idhost = models.ForeignKey(Host, models.DO_NOTHING, db_column='Host_idHost')  # Field name made lowercase.
    sampletype = models.CharField(db_column='SampleType', max_length=45, blank=True,
                                  null=True)  # Field name made lowercase.
...
class SetHasGene(models.Model):
    gene_idgene = models.OneToOneField(Gene, models.DO_NOTHING, db_column='Gene_IdGene',
                                       primary_key=True)  # Field name made lowercase.
...
class SetHasGenome(models.Model):
    set_idset = models.ForeignKey(Set, models.DO_NOTHING, db_column='Set_IdSet', blank=True,
                                  null=True)  # Field name made lowercase.
    genome_idgenome = models.ForeignKey(Genome, models.DO_NOTHING, db_column='Genome_IdGenome', blank=True,
                                        null=True)  # Field name made lowercase.
...
class Study(models.Model):
    ...
    studyname = models.CharField(db_column='StudyName', unique=True, max_length=45, blank=True,
                                 null=True)  # Field name made lowercase.
...
class Taxons(models.Model):
    ...
    item_iditem = models.ForeignKey(Item, models.DO_NOTHING, db_column='Item_idItem')  # Field name made lowercase.
    taxonomy = models.CharField(db_column='Taxonomy', max_length=2000, blank=True,
                                null=True)  # Field name made lowercase.
...
####### test orm file Ileum csv

#### Test ORM FRO ILEUM FILES CSV


from django.db.models import Q
from django.contrib.postgres.indexes import Index

class IleumCorrelation(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
            Index(
                fields=['accuracy', '-correlation'],  # Note: '-correlation' means descending order.
                name='idx_tc_ileum_explore',
                condition=models.Q(from_tissue='ileum', to_tissue='ileum'),
                include=['var1', 'var2', 'min', 'max', 'pvalue']
            ),
        ]

    def __str__(self):
        return f"{self.var1} ~ {self.var2} (corr={self.correlation}, p={self.pvalue})"


class MuscleCorrelation(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_muscle'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
            Index(
                fields=['accuracy', '-correlation'],  # Note: '-correlation' means descending order.
                name='idx_tc_muscle_explore',
                condition=models.Q(from_tissue='muscle', to_tissue='muscle'),
                include=['var1', 'var2', 'min', 'max', 'pvalue']
            ),
        ]
...
class LiverCorrelation(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_liver'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
            Index(
                fields=['accuracy', '-correlation'],  # Note: '-correlation' means descending order.
                name='idx_tc_liver_explore',
                condition=models.Q(from_tissue='liver', to_tissue='liver'),
                include=['var1', 'var2', 'min', 'max', 'pvalue']
            ),
        ]
...
class OtuCorrelation(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_otu'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
            Index(
                fields=['accuracy', '-correlation'],  # Note: '-correlation' means descending order.
                name='idx_tc_otu_explore',
                condition=models.Q(from_tissue='otu', to_tissue='otu'),
                include=['var1', 'var2', 'min', 'max', 'pvalue']
            ),
        ]
...
class AcidCorrelation(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_acid'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
            Index(
                fields=['accuracy', '-correlation'],  # Note: '-correlation' means descending order.
                name='idx_tc_acid_explore',
                condition=models.Q(from_tissue='acid', to_tissue='acid'),
                include=['var1', 'var2', 'min', 'max', 'pvalue']
            ),
        ]
...
class MetabCorrelation(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_metab'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
            Index(
                fields=['accuracy', '-correlation'],  # Note: '-correlation' means descending order.
                name='idx_tc_metab_explore',
                condition=models.Q(from_tissue='metab', to_tissue='metab'),
                include=['var1', 'var2', 'min', 'max', 'pvalue']
            ),
        ]
...
class FunctionnalCorrelation(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_functionnal'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
            Index(
                fields=['accuracy', '-correlation'],  # Note: '-correlation' means descending order.
                name='idx_tc_functionnal_explore',
                condition=models.Q(from_tissue='functionnal', to_tissue='functionnal'),
                include=['var1', 'var2', 'min', 'max', 'pvalue']
            ),
        ]
...
class OtuCorrelationRoss(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_otu_ross'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
...
class MuscleCorrelationRoss(models.Model):
    from_tissue = models.CharField(max_length=50)   # e.g. "ileum"
    to_tissue = models.CharField(max_length=50)       # e.g. "ileum", "muscle", etc.
    var1 = models.CharField(max_length=200)           # e.g. "2-Oxoglutaric acid_metab"
    var2 = models.CharField(max_length=200)           # e.g. "Acetic acid_acid"
    ...
    class Meta:
        # Your existing index on var1, var2 remains (if you still need it):
        db_table = 'avapp_tissuecorrelation_muscle_ross'
        managed  = False                      # don’t try to recreate it with migrations
        indexes = [
            models.Index(fields=["var1", "var2"]),
            # Adding a new index for the explore queries:
