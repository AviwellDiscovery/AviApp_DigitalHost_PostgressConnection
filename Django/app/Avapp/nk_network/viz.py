...
def to_cytoscape_elements(
    ...
    layers: dict,
    highlight: str | None,
    keep_root: tuple | None,
) -> list:
    """Convert edge DataFrame to Cytoscape elements."""
    elements: list = []
...
def apply_focus(elements: list, focus_node_cy: str | None) -> list:
    """Apply focus mode - highlight the focused node and its neighbors."""
